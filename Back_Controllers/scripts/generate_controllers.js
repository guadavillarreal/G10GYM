...
// Uso: node scripts/generate_controllers.js
...
`    });\\n` +
`};\\n\\n` +
`// Obtener por ID (sufijo ById para evitar nombres duplicados)\\n` +
`const Mostrar${capSingular}ById = (req, res) => {\\n` +
`    const {id} = req.params;\\n` +
